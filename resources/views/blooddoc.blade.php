...
<!--<li><a href="#3">Request Lab Report</a></li>-->
		...
		<div class="content col-md-9">
			...
			<td>{{$patient->id}}  </td>
				...
				@if(!$patient->blood)
				<td>
				<a  id="b1" class="btn btn-success" href="/markpresasapproved/{{$patient->id}}" role="button">To Request</a>
				</td>

				@else
				<td>
				<a  id="b1" class="btn btn-danger" href="/blooddoclab" role="button">To see the report</a>
				@endif
				</td>
