...
<!--<li><a href="#3">Request Lab Report</a></li>-->
		 ...
		 <li><a href="/doctormessage">Message</a></li>
		 </ul>
		</div>
		...
		<div class="content col-9">
			...
			<h6>
	 			Tharindu S. Divithura<br/>
				MBBS(Colombo), MD(Colombo), MRCP(UK)<br/>
			...
			<td>{{$patient->id}}  </td>
				...
				<a button class="btn btn-success" >Write the Prescription</a></button>
				@else
				...
				<a  id="b1" class="btn btn-success" href="/markdocpresasapproved/{{$patient->id}}" role="button">To Write </a>
			@endif
