...
@endif
			...
			<form class="form-horizontal" method="post" action="/savedrugs">
			{{csrf_field()}} 
			...
			<div class="form-group">
			 <table>
			    <tr>
				  <td>Product No</td>
				  <td><input type="text" name="Med_No" value="" size="40"/></td>
				</tr>
				<tr>
				   <td><br></td>
				</tr>
				...
				<tr>
				  <td>Batch No </td>
				  <td><input type="text" name="Batch_No" value="" size = "40"/></td>
				</tr>
				<tr>
				   <td><br></td>
				</tr>
				...
				<tr>
				  <td>Generic Name </td>
				  <td><input type="text" name="Med_name" value="" size="40"/></td>
				</tr>
				...
				<tr>
				  ...
				  <td><input type="date" name="Mnf_date" value="" placeholder="dd/mm/yyyy" size="40"/></td>
				</tr>
				<tr>
				   <td><br></td>
				</tr>
				...
				<tr>
				  <td>Expire Date </td>
				  <td><input type="date" name="Exp_date" value="" placeholder="dd/mm/yyyy" size="40"/></td>
				</tr>
				<tr>
				   <td><br></td>
				</tr>
				...
				<tr>
				  <td>Unit price </td>
				  <td><input type="text" name="Unit_Price" value="" size="40"/></td>
				</tr>
				 <tr>
				   <td><br></td>
				</tr> 
				...
				<tr>
				  <td></td>
				  <td><button type="submit" class="btn btn-success">Submit</button>&nbsp;&nbsp;<button type="Reset" class="btn btn-warning">Clear</button></td>
				</tr>
