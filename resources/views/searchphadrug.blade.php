...
<body>
	 ...
	 <div class="row">
		...
		<div class="content col-9">
			...
			<hr>	
			<h2>Search Drugs</h2></br>
			
            <div class="container">
		<form action="/searchdrug" method="POST" role="search">
			{{ csrf_field() }}
			<div class="input-group">
				<input type="text" id="searchbar" class="form-control" name="s"
					placeholder="Search Drug"> <span class="input-group-btn">
		...
		<div class="container">
			@if(isset($details))
			<p> The Search results for Drug No <b> {{ $query }} </b> are :</p>
			<h2>Drug  details</h2>
