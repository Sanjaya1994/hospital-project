...
<!--<li><a href="#3">Request Lab Report</a></li>-->
		...
		<div class="content col-md-9">
			...
			<td>{{$patient->id}}  </td>
				...
				<td>
				@if(!$patient->urine) 
				<a button  class="btn btn-success">Request Lab Report</a></button>
				@else
				<button class="btn btn-warning">Requested Lab Report</button>
				@endif </td>
			 ...
			 <td>
				...
				<a  id="b1" class="btn btn-success" href="/markurineasapproved/{{$patient->id}}" role="button">To Request</a>
				@else
				<a  id="b1" class="btn btn-danger" href="/urinedocrep" role="button">To see the report</a>
				@endif
				</td>
		...
		@if(!$ulab->active)
		<a button class="btn btn-warning">Not Complete</a>
